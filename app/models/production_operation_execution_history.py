...
class ProductionOperationExecutionHistory(Base):
    """
    Historical snapshot of production operation execution activity.
    """

    __tablename__ = "production_operation_execution_histories"
    ...
    production_operation_execution = relationship(
        ...
        back_populates="production_execution_histories",
    )
